...
/**
 * Handler for Quick Error Check command
 */
public class QuickErrorCheckHandler extends AbstractHandler {
    ...
    public Object execute(ExecutionEvent event) throws ExecutionException {
        ...
        if (selectedCode == null || selectedCode.trim().isEmpty()) {
            ...
            if (selectedCode == null || selectedCode.trim().isEmpty()) {
                EditorUtils.showMessage("Please select ABAP code or open an ABAP file to check for errors");
                return null;
            }
        }
        ...
        String prompt = ChatGPTService.ABAPPromptBuilder.buildErrorCheckPrompt(
        ...
        new Thread(() -> {
            try {
                ...
                EditorUtils.showErrorMessage("Quick Error Check Error", e.getMessage());
            }
        }).start();
        
        EditorUtils.showMessage("Quick Error Check request sent to AI Assistant");
        return null;
    }
}
